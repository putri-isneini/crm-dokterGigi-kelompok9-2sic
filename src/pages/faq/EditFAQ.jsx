...
const EditFAQ = () => {
  ...
  const handleUpdate = (e) => {
    ...
    const updatedFaqs = faqs.map((f) =>
      f.id === parseInt(id) ? { ...f, question, answer } : f
    )
  ...
  return (
    <div className="min-h-screen bg-pink-50 flex items-center justify-center px-4">
      ...
      >
        <h1 className="text-2xl font-bold text-rose-600 mb-6 text-center">Edit FAQ</h1>
        ...
        <textarea
          ...
          className="w-full p-3 border border-rose-300 rounded-lg mb-6 h-28"
        />
